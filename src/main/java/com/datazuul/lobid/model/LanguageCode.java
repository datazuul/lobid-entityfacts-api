...
public class LanguageCode extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(LanguageCode.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LanguageCode) == false) {
            return false;
        }
        LanguageCode rhs = ((LanguageCode) other);

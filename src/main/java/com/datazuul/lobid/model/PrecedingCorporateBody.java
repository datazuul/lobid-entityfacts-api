...
public class PrecedingCorporateBody {
    ...
    public String toString() {
        ...
        sb.append(PrecedingCorporateBody.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PrecedingCorporateBody) == false) {
            return false;
        }
        PrecedingCorporateBody rhs = ((PrecedingCorporateBody) other);

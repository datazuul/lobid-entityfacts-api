...
public class RelatedPlaceOrGeographicName {
    ...
    public String toString() {
        ...
        sb.append(RelatedPlaceOrGeographicName.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedPlaceOrGeographicName) == false) {
            return false;
        }
        RelatedPlaceOrGeographicName rhs = ((RelatedPlaceOrGeographicName) other);

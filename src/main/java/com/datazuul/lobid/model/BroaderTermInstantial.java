...
public class BroaderTermInstantial extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(BroaderTermInstantial.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BroaderTermInstantial) == false) {
            return false;
        }
        BroaderTermInstantial rhs = ((BroaderTermInstantial) other);

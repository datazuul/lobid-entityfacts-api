...
public class GndSubjectCategory extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(GndSubjectCategory.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GndSubjectCategory) == false) {
            return false;
        }
        GndSubjectCategory rhs = ((GndSubjectCategory) other);

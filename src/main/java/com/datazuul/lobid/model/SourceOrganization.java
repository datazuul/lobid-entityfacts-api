...
public class SourceOrganization {
    ...
    public String toString() {
        ...
        sb.append(SourceOrganization.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SourceOrganization) == false) {
            return false;
        }
        SourceOrganization rhs = ((SourceOrganization) other);

...
public class Wikipedium {
    ...
    public String toString() {
        ...
        sb.append(Wikipedium.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wikipedium) == false) {
            return false;
        }
        Wikipedium rhs = ((Wikipedium) other);

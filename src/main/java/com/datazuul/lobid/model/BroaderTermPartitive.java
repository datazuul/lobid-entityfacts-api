...
public class BroaderTermPartitive extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(BroaderTermPartitive.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BroaderTermPartitive) == false) {
            return false;
        }
        BroaderTermPartitive rhs = ((BroaderTermPartitive) other);

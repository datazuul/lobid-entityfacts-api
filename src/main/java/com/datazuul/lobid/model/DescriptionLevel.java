...
public class DescriptionLevel extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(DescriptionLevel.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DescriptionLevel) == false) {
            return false;
        }
        DescriptionLevel rhs = ((DescriptionLevel) other);

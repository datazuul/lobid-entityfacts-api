...
public class GeographicAreaCode extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(GeographicAreaCode.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeographicAreaCode) == false) {
            return false;
        }
        GeographicAreaCode rhs = ((GeographicAreaCode) other);

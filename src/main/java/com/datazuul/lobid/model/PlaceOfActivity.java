...
public class PlaceOfActivity {
    ...
    public String toString() {
        ...
        sb.append(PlaceOfActivity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PlaceOfActivity) == false) {
            return false;
        }
        PlaceOfActivity rhs = ((PlaceOfActivity) other);

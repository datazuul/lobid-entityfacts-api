...
public class GndSubjectCategoryId {
    ...
    public String toString() {
        ...
        sb.append(GndSubjectCategoryId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GndSubjectCategoryId) == false) {
            return false;
        }
        GndSubjectCategoryId rhs = ((GndSubjectCategoryId) other);

...
public class ProfessionOrOccupation {
    ...
    public String toString() {
        ...
        sb.append(ProfessionOrOccupation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProfessionOrOccupation) == false) {
            return false;
        }
        ProfessionOrOccupation rhs = ((ProfessionOrOccupation) other);

...
public class PlaceOfBusiness {
    ...
    public String toString() {
        ...
        sb.append(PlaceOfBusiness.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PlaceOfBusiness) == false) {
            return false;
        }
        PlaceOfBusiness rhs = ((PlaceOfBusiness) other);

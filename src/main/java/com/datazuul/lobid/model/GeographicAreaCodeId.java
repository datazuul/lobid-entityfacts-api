...
public class GeographicAreaCodeId {
    ...
    public String toString() {
        ...
        sb.append(GeographicAreaCodeId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeographicAreaCodeId) == false) {
            return false;
        }
        GeographicAreaCodeId rhs = ((GeographicAreaCodeId) other);

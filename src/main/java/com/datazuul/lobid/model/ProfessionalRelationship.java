...
public class ProfessionalRelationship {
    ...
    public String toString() {
        ...
        sb.append(ProfessionalRelationship.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProfessionalRelationship) == false) {
            return false;
        }
        ProfessionalRelationship rhs = ((ProfessionalRelationship) other);

...
public class FirstAuthor extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(FirstAuthor.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FirstAuthor) == false) {
            return false;
        }
        FirstAuthor rhs = ((FirstAuthor) other);

...
public class PlaceOfBirth {
    ...
    public String toString() {
        ...
        sb.append(PlaceOfBirth.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PlaceOfBirth) == false) {
            return false;
        }
        PlaceOfBirth rhs = ((PlaceOfBirth) other);

...
public class FieldOfStudy {
    ...
    public String toString() {
        ...
        sb.append(FieldOfStudy.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FieldOfStudy) == false) {
            return false;
        }
        FieldOfStudy rhs = ((FieldOfStudy) other);

...
public class ProfessionOrOccupationId {
    ...
    public String toString() {
        ...
        sb.append(ProfessionOrOccupationId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProfessionOrOccupationId) == false) {
            return false;
        }
        ProfessionOrOccupationId rhs = ((ProfessionOrOccupationId) other);

...
public class PlaceOfDeath {
    ...
    public String toString() {
        ...
        sb.append(PlaceOfDeath.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PlaceOfDeath) == false) {
            return false;
        }
        PlaceOfDeath rhs = ((PlaceOfDeath) other);

...
public class SpatialAreaOfActivity {
    ...
    public String toString() {
        ...
        sb.append(SpatialAreaOfActivity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SpatialAreaOfActivity) == false) {
            return false;
        }
        SpatialAreaOfActivity rhs = ((SpatialAreaOfActivity) other);

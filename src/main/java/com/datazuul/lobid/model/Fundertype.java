...
public class Fundertype {
    ...
    public String toString() {
        ...
        sb.append(Fundertype.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Fundertype) == false) {
            return false;
        }
        Fundertype rhs = ((Fundertype) other);

...
public class FamilialRelationship extends LobidIdentifiable {
    ...
    public String toString() {
        ...
        sb.append(FamilialRelationship.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FamilialRelationship) == false) {
            return false;
        }
        FamilialRelationship rhs = ((FamilialRelationship) other);

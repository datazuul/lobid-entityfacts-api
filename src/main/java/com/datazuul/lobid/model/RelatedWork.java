...
public class RelatedWork {
    ...
    public String toString() {
        ...
        sb.append(RelatedWork.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedWork) == false) {
            return false;
        }
        RelatedWork rhs = ((RelatedWork) other);

...
public class RelatedTerm {
    ...
    public String toString() {
        ...
        sb.append(RelatedTerm.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RelatedTerm) == false) {
            return false;
        }
        RelatedTerm rhs = ((RelatedTerm) other);
